...
export function PoolMarketCard({ pool }: PoolMarketCardProps) {
  return (
    <Link href={{ pathname: '/pool/[address]', params: { address: pool.address } }} asChild>
      <Pressable>
        <SectionCard className="gap-4 px-4 py-3">
          <View className="gap-3">
            ...
            <View className="gap-1 border border-sand-200 bg-sand-50 px-3 py-2">
          ...
          <View className="flex-row flex-wrap items-center justify-between gap-2.5 border-t border-sand-200 pt-3">
